...
def train_net(dataset_dir, weights_path=None, net_flag='vgg'):
    ...
    # ==============================================model保存路径====================================================
    model_save_dir = '/home/dl4/tuzengbing/yanxiao/data/model'
    ...
    with sess.as_default():
        ...
        if net_flag == 'vgg' and weights_path is None:
            pretrained_weights = np.load(
                '/home/dl4/tuzengbing/yanxiao/lanenet-lane-detection-master/vgg16.npy',
...
# 数据集路径   预权重路径  vgg
# r'/home/dl4/tuzengbing/data/model/tusimple_lanenet_vgg_2019-09-04-16-28-31.ckpt-1000'
train_net(r'/home/dl4/tuzengbing/yanxiao/data', r'/home/dl4/tuzengbing/yanxiao/data/model/tusimple_lanenet_vgg_2020-09-22-16-08-40.ckpt-9800', 'vgg')
# train_net(r'/home/dl4/tuzengbing/yanxiao/data',None,'vgg')